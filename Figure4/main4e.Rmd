...
# Written by Jonah Valenti, Emma Wrenn
---
...
down_tibble <- EWS_FLI1_df_new_tibble %>% filter(Pathways == "Kinsey_DOWN" | Pathways == "Riggi_DOWN" | Pathways == "Hancock_Lessnick_DOWN")
...
fusion_dnreg_CHLA10_20v3days <- GSEA(CHLA10_genelist, TERM2GENE=down_tibble, pvalueCutoff = 1.1, maxGSSize = 4000, nPermSimple = 100000)
fusion_dnreg_A673_20v3days <- GSEA(A673_genelist, TERM2GENE=down_tibble, pvalueCutoff = 1.1, maxGSSize = 4000, nPermSimple = 100000)
...
```{r}
dotplot_custom(fusion_dnreg_CHLA10_20v3days, showCategory = 3) + ggtitle("CHLA10 down sets") # main 4e
dotplot_custom(fusion_dnreg_A673_20v3days, showCategory = 3) + ggtitle("A673 down sets") # main 4e
