...
#Make the plot
upreg <- list(A673 = rownames(A673_DE_20days_upreg), CHLA10 = rownames(CHLA10_DE_20days_upreg))
downreg <- list(A673 = rownames(A673_DE_20days_downreg), CHLA10 = rownames(CHLA10_DE_20days_downreg))
...
Upreg_intersect_genes <- Reduce(intersect, list(A673 = rownames(A673_DE_20days_upreg), CHLA10 = rownames(CHLA10_DE_20days_upreg)))
Downreg_intersect_genes <- Reduce(intersect, list(A673 = rownames(A673_DE_20days_upreg), CHLA10 = rownames(CHLA10_DE_20days_upreg)))
