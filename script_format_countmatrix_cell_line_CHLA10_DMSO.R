...
samplesheet <- read.table("/active/taylor_s/people/nkatiy/CP-E_sarcoma_BETi/lawlorlab_shireen_2023.07.12_bulk_rnaseq_count_nf/resources/paired_end_samplesheet_CHLA10_DMSO.csv", sep=",", header=T)
#print(samplesheet)
...
write.table(count_mat1, "additional_results/Read_count_matrix_cell_line_CHLA10_DMSO.txt", sep="\t", quote=F)
