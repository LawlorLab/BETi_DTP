...
samplesheet <- read.table("/active/taylor_s/people/nkatiy/CP-E_sarcoma_BETi/lawlorlab_shireen_2023.07.13_bulk_rnaseq_tc32_count_nf/resources/paired_end_samplesheet_TC32_3days.csv", sep=",", header=T)
#print(samplesheet)

samplesheet <- samplesheet[samplesheet$cell_line=="TC32",]
#print(samplesheet)
...
filepath = "/active/taylor_s/people/nkatiy/CP-E_sarcoma_BETi/lawlorlab_shireen_2023.07.13_bulk_rnaseq_tc32_count_nf/paired_end_results/star/"
...
write.table(count_mat1, "additional_results/Read_count_matrix_cell_line_TC32_3days.txt", sep="\t", quote=F)
