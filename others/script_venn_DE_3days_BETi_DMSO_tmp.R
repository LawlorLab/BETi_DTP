...
A673_DE_3days_upreg <- A673_DE_3days %>% filter(log2FoldChange > 0, padj < 0.01)
CHLA10_DE_3days_upreg <- CHLA10_DE_3days %>% filter(log2FoldChange > 0, padj < 0.01)
TC32_DE_3days_upreg <- TC32_DE_3days %>% filter(log2FoldChange > 0, padj < 0.01)

A673_DE_3days_downreg <- A673_DE_3days %>% filter(log2FoldChange < 0, padj < 0.01)
CHLA10_DE_3days_downreg <- CHLA10_DE_3days %>% filter(log2FoldChange < 0, padj < 0.01)
TC32_DE_3days_downreg <- TC32_DE_3days %>% filter(log2FoldChange < 0, padj < 0.01)
